...
then
    ...
    echo "Congratulations! You have successfully launched the Apache Server. To see the server, refer to this: http://$IP" 
    echo "(Please note, if the server is still loading the page, 
          which means ec2-instance is still initializing the resources, so please be patient or check your ec2-instance status for here 
